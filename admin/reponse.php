...
mysql_select_db("sitw");
   ...
   mysql_query("update congé set reponse=\"demmande de cong&eacute; accept&eacute;\" where idcongé='$d'"); 
...
<div class="col">
		<?php
echo "demmande de cong&eacute; accept&eacute;e"; ?> </br>
<?php
    echo"<a href=\"repondreauconge.php\">retour</a>";
    ?>
 </div>
...
Do Not Remove this Credits and Link back to CSSHeaven from the template--> designed by <a href="index.html">proline</a> service</span>
</p>
</div>
</footer>
