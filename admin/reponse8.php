...
mysql_select_db("sitw");
   ...
   mysql_query("update ca set reponse=\"demande accept&eacute;e, un RDV avec la commission sera fix&eacute; prochainement\" where id_credit='$d'"); 
...
<h1 id="sitename"><img name="logo" src="images/logo.JPG" width="188" height="54" alt=""></h1>
  ...
  <ul id="sitenav">
  	<li><a href="clientcondif.php">G&eacute;rer client</a></li>
    <li class="current"><a href="empconfig.php">G&eacute;rer employ&eacute;</a></li>
    <li><a href="produitconfig.php">G&eacute;rer produits</a></li>
...
<div id="slider">	
	...
	<ul class="slides">
            ...
            <h2><a href="index.html">c'est un espace s&eacute;curis&eacute;</a></h2>
            <p> </p>
			</div></li>
			<li>
...
<div class="col">
		<?php
echo "demmande de Cr&eacute;dit accept&eacute;e"; ?> </br>
<?php
    echo"<a href=\"repondreauca.php\">retour</a>";
    ?>
 </div>
...
<p>&nbsp;</p>
<div class="clear">
  <div align="center"><a href="deconnexionadmin.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="60" height="50" /></a></div>
...
Do Not Remove this Credits and Link back to CSSHeaven from the template--> d&eacute;signed by <a href="index.html">proline</a> service</span>
</p>
</div>
</footer>
