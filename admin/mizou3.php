<?php
if (isset($_POST['xo'])&&isset($_POST['lol'])){
$xo=$_POST['xo'];
$lol=$_POST['lol'];
mysql_connect("localhost","root","");
mysql_select_db("sitw");
mysql_query("update reclamation set reponse='$lol' where idrec='$xo'");
...
<h1> le message a &eacute;t&eacute; bien envoy&eacute;</h1>
<a href="lire.php">Retour</a>
</div>
<div class="col">
