...
<div id="topcolumns">
<div class="col">
  <h2>voila la liste des clients:</h2>
  <p>pour bloquer ou débloquer un client il suffit cliquer sur action pour changer sa situation  </p>
  <p>&nbsp;</p>
  <p align="right">&nbsp;</p>
  <p>&nbsp;</p>
</div>
...
$req=mysql_query("update client set etat=\"oui\" where id='$idd'");
echo "client bloqué";
echo"<p><a href=\"debloc2.php\">Retour</a></p>";
?>
