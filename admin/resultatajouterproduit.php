...
?>
<?php
if (isset($_POST['nom'])&& isset($_POST['prix'])&& isset($_POST['des'])&& isset($_POST['qte'])&& isset($_POST['image'])){
$nom=$_POST['nom'];
$prix=$_POST['prix'];
$des=$_POST['des'];
$qte=$_POST['qte'];
...
mysql_query("insert into produit values('','$nom','$prix','$des','$image','$qte')");
}
...
<h1 id="sitename"><img name="logo" src="images/logo.JPG" width="188" height="54" alt=""></h1>
  ...
  <ul id="sitenav">
    ...
    <li class="current"><a href="produitconfig.php">Gérer produits</a></li>
...
<div id="topcolumns">
<div class="col">
  <h2>Le Produit a été ajouté avec succé! <img name="" src="images/valider.jpg" width="54" height="55" alt=""></h2>
  <p>&nbsp;</p>
  <p align="right">&nbsp;</p>
  <p>&nbsp;</p>
</div>
<div class="col">
  <h2>choisissez l'endoit ou vous voulez revenir: </h2>
  <p></p>
  <p></p>
  <ol>
    <li><a href="ajouterproduit2.php"><strong>ajouter autres Produit </strong></a></li>
    <li><a href="persoadmin.php"><strong>revenir a l'éspace admin  </strong></a></li>
    <li><a href="deconnexionadmin.php"><strong>se déconnecter </strong></a></li>
    </ol>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
