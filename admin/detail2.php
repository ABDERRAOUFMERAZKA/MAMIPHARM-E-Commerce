...
<h1 id="sitename"><img name="logo" src="images/logo.JPG" width="188" height="54" alt=""></h1>
  ...
  <ul id="sitenav">
  	<li class="current"><a href="clientcondif.php">Gérer client</a></li>
    <li><a href="empconfig.php">Gérer employé</a></li>
    <li><a href="produitconfig.php">Gérer produits</a></li>
    <li><a href="lirecv.php">Les CV</a></li>
...
<div class="col">
<center><table width="497" height="48" border="1">
  <tr>
    <th height="42" scope="col">id-panier</th>
...
$req=mysql_query("SELECT * FROM ligne where idpanier='$s'");
while($se=mysql_fetch_array($req)){ ?>
<center><table width="497" height="56" border="1">
  <tr>
    <th width="125" scope="col"><?php echo $se['idpanier'];?></th>
    <th width="98" scope="col"><?php $o=$se['idproduit'];$q=mysql_query("SELECT * FROM produit where id='$o'");$i=mysql_fetch_array($q); echo $i['nom']; ?></th>
    <th width="114" scope="col"><?php echo $se['qte'];?></th>
    <th width="132" scope="col"><?php echo $se['stotale'];?></th>
  </tr>
</table></center>
<div align="right">
  <?php } ?><center><table width="548" border="0">
  <tr>
    <th width="128" scope="col"></th>
    <th width="103" scope="col"></th>
    <th width="112" scope="col"></th>
    <th width="163" scope="col"><p>Montant Global</p><p><?php
 $t=mysql_query("SELECT * FROM panierr where idpanier='$s'");
...
<p>&nbsp;</p>
<div class="clear">
   <div align="center"><a href="javascript:window.print()"><img src="imprimer.jpg" width="60" height="72"></a><a href="deconnexionadmin.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="74" height="66" /></a><a href="voivmd.php">Retour</a></div>
