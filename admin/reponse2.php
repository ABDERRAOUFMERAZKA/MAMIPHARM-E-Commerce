...
mysql_select_db("sitw");
   ...
   mysql_query("update congé set reponse=\"demmande de cong&eacute; refus&eacute;e\" where idcongé='$d'"); 
...
<div id="slider">	
	...
	<ul class="slides">
            ...
            <h2><a href="index.html">c'est un espace sécuris&eacute;</a></h2>
            <p> </p>
			</div></li>
			<li>
...
<div class="col">
	<?php
  echo "demmande de cong&eacute; refus&eacute;e";
  ?> </br>
  <?php
