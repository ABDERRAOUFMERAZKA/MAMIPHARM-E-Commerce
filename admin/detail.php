...
<div class="col">
<center><table width="497" border="1">
  <tr>
    <th height="49" scope="col">id-commande</th>
...
$req=mysql_query("SELECT * FROM commande where id='$s'");
while($g=mysql_fetch_array($req)){?>
<center><table width="497" border="1">
  <tr>
    <th width="151" height="35" scope="col"><?php echo $g['idcomd']; ?></th>
    <th width="183" scope="col"><?php echo $g['date']; ?></th>
    <th width="66" scope="col"><?php $a=$g['idpanier']; $q=mysql_query("SELECT * FROM panierr where idpanier='$a'");$x=mysql_fetch_array($q); echo $x['totale'];  ?></th>
    <th width="69" scope="col"><?php echo"<a href=\"detail2.php?repo=$a\">détail </a>";?></th>
  </tr>
</table></center>
<?php } ?>
</div>
...
<p>&nbsp;</p>
<div class="clear">
   <div align="center"><a href="deconnexionadmin.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="105" height="95" /></a> <a href="voivmd.php">Retour</a></div>
</div>
