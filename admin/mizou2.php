...
$r=mysql_query("select * from reclamation where idrec='$a'");
$rep= mysql_fetch_array ($r);
echo $rep['prob'];

?>
<html>
<body>
<form action="mizou3.php" method="post">
<input type="hidden" name="xo" value="<?php echo($a); ?>">
<textarea rows="10" cols="50" name="lol"></textarea>
<input type="submit" value="Envoyer">
</form>
<?php   echo"<a href=\"lire.php\">retour</a>";?>
 </body>
 </html>
</div>
<p>&nbsp;</p>
