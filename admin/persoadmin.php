...
<h1 id="sitename"><img name="logo" src="images/logo.JPG" width="188" height="54" alt=""></h1>
  ...
  <ul id="sitenav">
	...
	<li><a href="art.php"> article</a></li>
...
<div class="col">
  ...
  <p><img name="" src="images/admin (2).png" width="190" height="131" alt=""><img name="" src="images/valider.jpg" width="61" height="45" alt=""> </p>
  <p align="right">&nbsp;</p>
  <p>&nbsp;</p>
</div>
<div class="col">
...
-->
 ...
 <h1 align="center">Bienvenue,<span class="Style1"><?php echo $_SESSION['user']; ?></span> sur l'espace administratif proline </h1>
 
 <p>&nbsp;</p>
 <p>&nbsp;</p>
 <h2> veuillez choisissez l'opération voulu en cliquant sur un des onglet au menu de la page </h2>
 <p>&nbsp;</p>
