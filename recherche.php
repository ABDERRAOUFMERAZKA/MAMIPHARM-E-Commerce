...
<div class="col">
  <h2>rechercher produits <img name="" src="images/recherche.gif" width="68" height="54" alt=""></h2>
  <p><strong>veuillez saisir le mot clé de produit dans le moteur de recherche.... </strong></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <table width="292" height="69" border="0">
  <form name="recherche" action="php2.php" method="post" >
    <tr>
      <td><input type="text" name="a" value="" size="45" /></td>
    </tr>
    <tr>
      <td><p align="right"><input type="submit" value="rechercher"/>
          <a href="deconnexionclient.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" alt="" width="82" height="49" border="0"></a> <a href="persoclient.php"> Retour </a></p></td>
