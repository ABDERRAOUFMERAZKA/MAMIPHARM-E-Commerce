...
if (isset($_POST['03']) && isset($_POST['04']) && isset($_POST['05'])){
$client = $_SESSION['user'];
$mail=$_POST['03'];
$tef=$_POST['04'];
$pb=$_POST['05'];
mysql_query("INSERT INTO reclamation (idrec,E_mail,tef,prob,id) VALUES('','$mail','$tef','$pb','$client')");
}
?>
<section id="page">
<div id="bodywrap">
...
<div class="col">
  <img src="images/valider.jpg" width="104" height="64" alt="graph" class="imgright">
  <h2>Votre Réclamation a été Bien envoyé.</h2>
  <p>&nbsp;</p>
  <p>vous receverez la réponse de l'entreprise sur votre adresse E_mail. </p>
  <p align="center"><a href="persoclient.php">revenir a l'éspace ? </a></p>
</div>
<div class="col">
  <h2>&nbsp;</h2>
</div>
