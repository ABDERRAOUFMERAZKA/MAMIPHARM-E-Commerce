...
-->
 ...
 <h1 align="center">Bienvenue,<span class="Style1"><?php echo $_SESSION['user']; ?></span> sur votre espace personnel</h1>
 ...
 <ol>
   <li>
     ...
     <a href="recherche.php">Rechercher Produit</a></li>
   
   <li><a href="reclamation.php">Poser réclamation</a></li>
   <li><a href="mes.php">Ma messagerie </a></li>
 </ol>
 <ul><li></li>
 ...
 <p>&nbsp;</p>
 <div align="center"><a href="deconnexionclient.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="105" height="95" /></a>   </div>
 </div>
</div>
<div class="col">
