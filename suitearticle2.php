...
<div id="topcolumns">
  <div class="clear">
    ...
    <p class="testimonials">L'entreprise <span class="Style2">MAMI PROCOPHARM</span> commence le rembourcement des produit déféctueux a cause des érreures de distribution du 1er semestre 2013...tout client n a pas encore déposé sa réclamation avant les délais ne sera pas concerné.</p>
    <p class="testimonials">les réclamations doivent etres déposés exclusivement dans le site web Proline. </p>
    <article>
