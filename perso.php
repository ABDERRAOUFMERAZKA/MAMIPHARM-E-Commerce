...
<div id="topcolumns">
<div class="col">
  <h2>Authentification réussite ! </h2>
  <p><img name="" src="images/check-user-icon.png" width="128" height="128" alt=""></p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</div>
...
-->
 ...
 <h1 align="center">Bienvenue,<span class="Style1"><?php echo $_SESSION['user']; ?></span> sur votre escpace personnel</h1>
 
 <p>&nbsp;</p>
 <p>&nbsp;</p>
 <p><h3><strong>vous souhaitez :</strong></h3>
 
 <ol>
   <li>
     </p>
     <a href="cong2.php">Demmander  congé</a></li>
   <li><a href="pbm2.php">Poser commentaire</a></li>
   <li><a href="ca.php">Demander crédit d'achat </a></li>
   <li><a href="trois.php">Ma messagerie </a></li>
 </ol>
 <ul><li></li>
   <li></li>
 </ul>
 <p>&nbsp;</p>
 <div align="center"><a href="deconnexionemploye.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="105" height="95" /></a>   </div>
 </div>
</div>
<div class="col">
