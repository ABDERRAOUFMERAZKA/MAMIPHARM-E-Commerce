...
<div id="topcolumns">
  <div class="clear">
    <h2 align="left">Nos services <img name="" src="images/services.JPG" width="122" height="57" alt=""></h2>
    <article>
      <p class="Style1">*<strong>Télévente :</strong></p>
      <p>-Un service de télévente des produits pharmaceutiques, parapharmaceutiques et cosmétiques pour vous servir.</p>
      <p class="Style1">*<strong>Livraison a votre officine:</strong></p>
      <p>-Une livraison de votre commande a l'officine dans les plus brefs délais.</p>
      <p><span class="Style1">*<strong>S A V:</strong></span></p>
      <p>-Un service d'aprés vente ouvert a votre disosition selon les horaires de travail.<a href="index.php">Retour  </a></p>
      </article>
  </div>
