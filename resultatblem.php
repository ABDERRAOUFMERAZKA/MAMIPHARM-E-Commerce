...
mysql_query("INSERT INTO commentaire values ('','$me','$hh','')");
}
?>
<!doctype html>
...
<div class="col">
  <img src="images/valider.jpg" width="72" height="59" alt="graph" class="imgright">
  <h2>Votre commentaire a été Bien envoyé.</h2>
  <p>&nbsp;</p>
  <p>vous receverez la réponse de l'entreprise sur votre espace personel dans les plus brèfs délais </p>
  <p>&nbsp;</p>
  <p><a href="perso.php">revenir a mon espace</a> </p>
</div>
<div class="col">
  <h2>&nbsp;</h2>
</div>
