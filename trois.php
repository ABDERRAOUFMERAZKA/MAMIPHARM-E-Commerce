...
<html>
<body>
 <h1 align="center"><strong>Bienvenue,<span class="Style1"><?php echo $_SESSION['user']; ?></span> sur votre Messagerie </strong></h1>
 <p>&nbsp;</p>
 <p>&nbsp;</p>
 <ul>
   <li><span class="Style2">1-</span><strong><a href="12.php">Réponses des demandes congés </a></strong></li>
   <p>&nbsp;</p>
   <li><span class="Style2">2-</span><a href="13.php"><strong>Réponses aux commentaires</strong></a></li>
   <p>&nbsp;</p>
   <li><span class="Style2">3-</span><a href="14.php"><strong>Réponses des demandes de crédit d'achat</strong></a></li>
   <p>&nbsp;</p>
 </ul>
 ...
 <div align="center"><a href="deconnexionemploye.php"><img src="images/16624448-deconnexion-rouge-brillant-reflete-bouton-carre.jpg" width="105" height="95" /></a>  <a href="perso.php">Retour </a> </div>
