...
<h1 id="sitename"><img name="logo" src="images/logo.JPG" width="188" height="54" alt=""></h1>
  ...
  <ul id="sitenav">
    ...
    <li class="current"><a href="01emp.php">Employ&eacute;</a></li>
...
<div id="slider">	
	...
	<ul class="slides">
            ...
            <h2><a href="index.html">Notre site web permet aux clients de r&eacute;diger leurs commandes en ligne</a></h2>
            <p> </p>
			</div></li>
			<li>
			  <div class="thumbholder"><img src="images/mami2.jpg" width="413" height="220" alt="First Image" /></div><div class="txtholder">
            <h2><a href="index.html">Le payement des factures et l'inscription des clients seront &eacute;ffectu&eacute;s au sein de l'entreprise selon la loi interne de l'entreprise MAMI PROCOPHARM</a></h2>
            <p></p>
			</div></li>
			<li><div class="thumbholder"><img src="images/mamiproco.jpg" width="413" height="220" alt="First Image" /></div><div class="txtholder">
            <h2><a href="index.html">L'entreprise Mami procopharm cherche des diplom&eacute;s en sp&eacute;cialit&eacute;s suivante :</a></h2>
