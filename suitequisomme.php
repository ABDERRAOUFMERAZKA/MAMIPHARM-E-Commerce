...
<div id="topcolumns">
  <div class="clear">
    <h2>Qui sommes-nous <img name="" src="images/icon2.jpg" width="122" height="57" alt=""></h2>
    <article>
      <p><a href="http://localhost/proline/index.html">Bienvenue sur Proline:</a></p>
      <p>Proline est le site web officiel de l'entreprise Mami Procopharm, c'est un service de commande et de recrutement en ligne, il met au disposition des clients la possibilité de commander des produits pharmaceutiques et parapharmaceutique.. notre site web porte un espace d'employés dans lequel ils peuvent poser leurs réclamations et passer les différentes demandes au service de DRH sans deplacer.</p>
      <p>Notre service est ouvert 7j/7j 24h/24h.<a href="index.php">Retour  </a></p>
      </article>
  </div>
