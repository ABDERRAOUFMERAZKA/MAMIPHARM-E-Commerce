...
if (isset($_POST['01'])&& isset($_POST['02']) && isset($_POST['03']) && isset($_POST['04'])){
$nom=$_POST['01'];
$prénom=$_POST['02'];
$mail=$_POST['03'];
$mess=$_POST['04'];
mysql_query("INSERT INTO message (ID_message,nom_emetteur,prenom_emetteur,E_mail,Message) VALUES('','$nom','$prénom','$mail','$mess')");
}
else {
...
<div class="col">
  ...
  <h2>Votre Message a été Bien envoyé.</h2>
  <p>&nbsp;</p>
